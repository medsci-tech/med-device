...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['products'] = Product::orderBy($sort, 'desc')->where('category_id', 106)->paginate('20');

        return view('admin.member.product.index', $data);
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('admin.member.product.index', [
            'products' => Product::where('category_id', 106)->search($keyword)->orderBy($sort, 'desc')->paginate('20'),
            'sort' => $sort
        ]);
    }
    ...
    {
        return view('admin.member.product.create', [
    ...
    public function store(Request $request)
    {
        ...
        Product::create($data);
        return redirect('/admin/member/product');
    }
    ...
    {
        return view('admin.member.product.edit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.member.product.index');
    }
