...
@section('main')
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">商品教育视频列表</strong> /
                <small>商品教育视频列表</small>
            </div>
        </div>
                ...
                <form class="am-form">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tr>
                            ...
                            <th class="table-title">腾讯云app_id</th>
                            <th class="table-type">腾讯云file_id</th>
                        ...
                        @foreach($videos as $video)
                            <tr>
                                <td>{{$video->id}}</td>
                                <td><a href="#">{{$video->qcloud_app_id}}</a></td>
                                <td><a href="#">{{$video->qcloud_file_id}}</a></td>
                                <td><a href="#">{{$video->product ?$video->product->name :'-'}}</a></td>
                                <td><a href="#">{{$video->created_at}}</a></td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            ...
                                            <a type="button" class="am-btn am-btn-danger"
                                               id="delete{{$video->id}}"><span class="am-icon-remove"></span>
                                                删除</a>
                                        </div>
                                    </div>
                                </td>
