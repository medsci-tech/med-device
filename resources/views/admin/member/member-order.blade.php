    ...
    <div class="admin-content">
        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-12">
                <a href="/admin/member/member-down-order-excel?date=today" type="button" class="am-btn am-btn-default">今日订单</a>
                <a href="/admin/member/member-down-order-excel?date=yesterday" type="button"
                   class="am-btn am-btn-primary">昨日订单</a>
                <a href="/admin/member/member-down-order-excel?date=week" type="button"
                   class="am-btn am-btn-secondary">最近7天订单</a>
                <a href="/admin/member/member-down-order-excel?date=month" type="button"
                   class="am-btn am-btn-success">最近30天订单</a>
            </div>
        </div>
        <div class="am-g" style="margin-top: 15px">
            <div class="am-u-sm-12 am-u-md-6">
                <form action="/admin/member/member-order/search" method="post">
