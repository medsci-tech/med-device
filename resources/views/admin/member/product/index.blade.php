            ...
            <div class="am-u-sm-12 am-u-md-3">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs empty-a">
                        <a href="/admin/member/product/create" type="button" class="am-btn am-btn-success"><span
                    ...
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td class="am-hide-sm-only">{{$product->beans}}</td>
                                ...
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="/admin/member/product/{{$product->id}}/edit"
